...
//try{
//var AWSDK = require('AWSDK/AWSDK');
//var controller = AWSDK.AWController;
//Ti.API.info('AWSDK: ' + AWSDK);
//var AWController = require('AWSDK/AWController');
//Ti.API.info("AWController: " + AWController + "| Not null: "+ (AWController != null));
//}catch(e){
//	Ti.API.info("AWController not loaded");
//}
